...
<head>
	...
	<meta http-equiv="refresh" content ="3;url=<%=request.getContextPath()%>/waterfall/waterfall.do?action=getOne_For_Display&wf_no=${waterfallVO.wf_no}">
...
<body onload="shownum()">
	...
	<div class="container min-vh-100" >
		<div id="row">
			...
			<div >
				<a href="<%=request.getContextPath()%>/waterfall/waterfall.do?action=getOne_For_Display&wf_no=${waterfallVO.wf_no}" >不想等待請點擊此</a>
			</div>
		</div>
	</div>
