					...
					<div class="card shadow mb-4">
						<div class="card-header py-3" style="display: inline-block;">
							<h6 class="m-0 font-weight-bold text-primary"
								style="display: inline-block; padding: 10px;">管理員管理</h6>
							<a
								href="<%=request.getContextPath()%>/back-end/adminis/listAdminisOnline.jsp"
								class="btn btn-primary btn-icon-split"
								style="display: inline-block;"> 
								<span class="icon text-white-50">
							<i class="fas fa-flag"></i>
							</span> 
							<span class="text">在職員工</span>
							</a> 
							<a href="<%=request.getContextPath()%>/back-end/adminis/listAdminisOffline.jsp"
								class="btn btn-primary btn-icon-split"
								style="display: inline-block;"> <span
								class="icon text-white-50"> <i class="fas fa-flag"></i>
							</span> <span class="text">離職員工</span>
							</a>
						</div>
										...
										<tr>
											...
											<td>
												<FORM METHOD="post"
													...
													<input type="hidden" name="adminis_no"
														value="${adminisVO.adminis_no}"> <input
