...
<%
	...
	List<AdminisVO> list = AdminisSvc.getAdminisStat(0);
				...
				<div class="container-fluid">
					<div class="card shadow mb-4">
						<div class="card-header py-3" style="display: inline-block;">
							<h6  class="m-0 font-weight-bold text-danger" style="display: inline-block; padding:10px;" >離職管理員管理</h6>
								  ...
								  <a href="<%=request.getContextPath()%>/back-end/adminis/listAdminisOnline.jsp" class="btn btn-primary btn-icon-split"  style="display: inline-block;">
                   				  <span class="icon text-white-50">
                    			  <i class="fas fa-flag"></i>
                   				  </span>
