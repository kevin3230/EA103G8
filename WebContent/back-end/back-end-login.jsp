...
<% session.setAttribute("adminis_no", null); %>
...
<head>
    ...
    <title>Planing Adminis Login</title>
    ...
    <link href="<%=request.getContextPath()%>/utility/back-end/css/sb-admin-2.css" rel="stylesheet">
</head>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" ACTION="<%=request.getContextPath()%>/adminis/adminis.do" METHOD="post">
                                        <div class="form-group">
                                            <input type="text" name="adminis_no" class="form-control form-control-user" id="exampleInputAdminisNO"  placeholder="Enter  Adminis No....">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="adminis_pwd" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                                        </div>
                                        <div class="form-group">
