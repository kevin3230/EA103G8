...
public class VdSignUpMail {
	...
	public VdSignUpMail(String to, String str_name, String verificationcode) {
		this.to = to;
...
//			message.setText(messageText);
			message.setContent("Hello! " + str_name + " 歡迎註冊成為PLAMPING業者，請謹記開通密碼:<h3 style=\"color:red;\"> " + verificationcode + "</h3><br/>"
